...
public class DropDownView extends RelativeLayout {
    ...
    private View emptyDropDownSpace; // 空的空间
    private TransitionSet expandTransitionSet;     // 扩张  继承自 Transition 过渡的动画
    private TransitionSet collapseTransitionSet;   // 折叠
    private ObjectAnimator shadowFadeOutAnimator;  // 属性动画
